...
class App extends Component {
  ...
  onMatchImg = thumbImgUrl => {
    const {imgUrl} = this.state
    const matchImgList = imagesList.filter(
      eachItem => eachItem.thumbnailUrl === thumbImgUrl,
    )
    const {imageUrl} = matchImgList[0]
    if (imageUrl === imgUrl) {
      const newImgUrl =
  ...
  render() {
    const {score, seconds, tabId, imgUrl, isFinish} = this.state
    ...
    return (
      <div>
        <nav className="nav-bg">
          ...
          <ul className="score-timer-container">
            ...
            <li className="timer-container">
              ...
              />
              <p className="score-style">{seconds} sec</p>
            </li>
          </ul>
        </nav>
        {isFinish && (
          <div className="bg-container">
            <div className="game-over-bg">
              ...
              />
              <p className="game-end-score">YOUR SCORE</p>
              <p className="game-end-score">{score}</p>
              <button
                type="button"
                className="reset-btn"
              ...
              >
                <div className="reset-con">
                  <img
                    ...
                    alt="reset"
                  />
                  <p className="score-txt">PLAY AGAIN</p>
                </div>
              </button>
            </div>
          </div>
        ...
        {!isFinish && (
          <div className="bg-container">
            <img src={imgUrl} className="big-image-style" alt="match" />
            <ul className="tab-item-container">
              {tabsList.map(eachItem => (
                <li key={eachItem.tabId} className="list-btn">
                  <button
                    type="button"
                    className={
                    ...
                    onClick={() => this.onChangeTabId(eachItem.tabId)}
                  >
            ...
            <ul className="thumb-img-container">
              {thumbnailList.map(eachItem => (
                <li key={eachItem.id}>
                  <button
                    type="button"
                    className="thumb-btn-style"
                    onClick={() => this.onMatchImg(eachItem.thumbnailUrl)}
                  >
                    <img
                      src={eachItem.thumbnailUrl}
                      className="thumb-img-style"
                      alt="thumbnail"
                    />
                  </button>
                </li>
